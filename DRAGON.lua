...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/OSDDR/star/main/File_Bot/commands.lua") 
...
os.execute('wget https://raw.githubusercontent.com/OSDDR/star/main/DRAGON.lua')
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بوت اليوتيوب ♥️',url="t.me/Ssociial_bot"}},
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/OSDDR/star/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/OSDDR/star/main/File_Bot/"..file)
if res == 200 then
